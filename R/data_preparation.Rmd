...
## adding short country names 
cbcr_eatr %<>% mutate(short_name = countrycode(JUR, "iso3c", "cldr.short.en"))
...
plot_parameters <- function(data, countrygroup){
  ggplot(filter(data, income==countrygroup&effective_rate>=0&effective_rate<1), aes(x=reorder(short_name, total_subgroups)))+
