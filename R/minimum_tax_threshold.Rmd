...
To reproduce the analysis, download the folder and execute the RMarkdown file ["R/minimum_tax_threshold.Rmd"](https://github.com/fheitmueller/cbcrdata/blob/main/R/data_exploration.Rmd). You need a recent version of [R](https://www.r-project.org/) and [RStudio](https://www.rstudio.com/). 
